      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <div className="flex flex-col justify-start pt-0 md:pt-8">
            ...
            <div className="space-y-5 text-[15px] md:text-base leading-relaxed text-foreground font-sans">
              <p>
              ...
              <a
                ...
                className="inline-block italic text-foreground hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
              >
                ¿Hablamos?
              </a>
            </div>
