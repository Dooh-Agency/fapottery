...
const COPY = {
  ...
  en: {
    ...
    description: "Leave your email and we will send you the booking information for the next Breakfast & Paint: Saturday, August 1 · 11:00 am to 1:00 pm.",
    name: "Name (optional)",
    email: "Your email",
    ...
    submit: "Send me the information",
    successTitle: "You're on the interest list!",
    successDescription: "We will send you the booking information for the next Breakfast & Paint.",
