...
const Footer = () => {
  ...
  return (
    <footer className="bg-background text-foreground" aria-label={t("footer.pieDePagina")}>
      {/* Logo */}
      <div className="container mx-auto px-6 pt-16 pb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12">
          {/* Brand */}
          <div>
            <p className="text-sm font-sans font-semibold mb-2">{t("footer.brandTitle")}</p>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground font-sans mb-1">{t("footer.malagaLabel")}</p>
            <a
          ...
          {/* Nav Links */}
          <nav aria-label={t("footer.enlaces")} className="flex flex-col gap-1.5">
            {navItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
